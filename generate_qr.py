...
Generates high-resolution, print-ready QR codes with official Olive Leaf emblem and standee graphics.
"""
...
def create_qr_codes(target_url=DEFAULT_URL):
    ...
    # 3. QR Code with Official Olive Emblem in Center
    ...
    # If official emblem exists, paste it with rounded border
    ...
    print("  [+] Saved qr_code.png with official Olive emblem!")
...
def generate_standee_card(qr_img):
    ...
    loc_text = "Shop 9, 10 Ground Floor, Skye Corporate Park, Scheme 78, Vijay Nagar, Indore"
    lb = draw.textbbox((0, 0), loc_text, font=footer_font)
    draw.text(((w - (lb[2] - lb[0])) // 2, 1560), loc_text, fill="#8ca398", font=footer_font)

    phone_text = "Call / Reservation: 9993896969"
    ...
    print("  [+] Saved table_standee_printable.png (With official Olive Leaf logo!)")
